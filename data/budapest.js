...
const DATA = {
  ...
  mapaZonas: {
    ...
    zonas: [
      { id: "castillo", nombre: "Buda · Castillo", corto: "BUDA", sub: "Colina, murallas y termas", barrios: ["castillo"], centro: [47.4962, 19.0396], radio: 1.55, path: "M40 60 Q165 20 285 75 L285 235 Q160 265 45 205 Z", label: [165, 120], visual: "bastion", extras: {
      ...
      { id: "centro", nombre: "V · Belváros", corto: "BELVÁROS", sub: "Parlamento y Danubio", barrios: ["v"], centro: [47.5000, 19.0520], radio: 1.25, path: "M385 100 Q455 70 520 110 L515 250 Q450 275 385 235 Z", label: [450, 160], visual: "parlamento" },
      { id: "andrassy", nombre: "VI · Andrássy", corto: "ANDRÁSSY", sub: "Imperio y memoria", barrios: ["vi"], centro: [47.5065, 19.0650], radio: 1.25, path: "M455 20 Q525 5 585 45 L555 155 L500 155 Z", label: [525, 75], visual: "andrassy" },
      ...
      { id: "varosliget", nombre: "Városliget", corto: "VÁROSLIGET", sub: "Héroes y Széchenyi", barrios: ["varosliget"], centro: [47.5150, 19.0770], radio: 1.55, path: "M590 30 Q665 15 710 55 L700 150 Q640 165 570 135 Z", label: [645, 78], visual: "heroes", extras: {
      ...
      { id: "memento", nombre: "Memento Park · Budafok", corto: "MEMENTO", sub: "Estatuas, bodegas y periferia", barrios: [], centro: [47.4269, 19.0002], radio: 1.2, path: "M8 335 Q60 310 115 335 L125 415 L10 415 Z", label: [65, 365], visual: "socialismo-hungaro", visualExt: "webp", extras: {
  ...
  /* ---------- PRÁCTICO ---------- */
  practico: {
    calor: { titulo: "🥵 OLA DE CALOR: leed esto", texto: "Aviso serio (previsión actualizada a 22-jul): vuestro finde cae en plena ola de calor, y va a MÁS. Máximas: viernes 31 ~33°, sábado 1 ~34°, domingo 2 ~36° (el del Parlamento) y lunes 3 hasta ~38° — el día más infernal, aunque os pilla de salida a mediodía. Con estos números el plan no es sugerencia, es supervivencia: (1) todo lo de calle, temprano o al atardecer; de 12 a 17 h, sombra, museo, terma o siesta; (2) hidratación agresiva, botella siempre encima (hay fuentes de agua potable por la ciudad); (3) el domingo, Széchenyi a primera hora y dentro del Parlamento a las 14:15 con aire — vuestro plan ya lo esquiva; (4) gorra, protección solar y ropa clara; (5) el baño nocturno de Rudas el viernes es, con este calor, la mejor idea del viaje; (6) el lunes, con 38°, moveos pronto: desayuno, últimas compras y al aeropuerto sin heroicidades al sol. La escena nocturna del VII no sufre: se vive de noche, que es cuando por fin refresca.", fiab: "ok", fuente: "Open-Meteo + met.hu · ver. 22-jul-2026" },
